...
//                .andExpect(MockMvcResultMatchers.jsonPath("$.ticketDirectionFrom", Matchers.is(1)))
//                .andExpect(MockMvcResultMatchers.jsonPath("$.ticketDirectionTo", Matchers.is(2)));
//
...
//                .content(objectMapper.writeValueAsString(createFixtureForAllDeriction(1)))
//                .accept(MediaType.APPLICATION_JSON_UTF8))
...
//        Ticket ticket = createFixtureForAllDeriction(1);
...
//
//        Mockito.verify(ticketService, Mockito.times(1)).delete(1);
//    }
//
//    @Test
...
//        ticket.setTicketDirectionFrom(ticketId);
//        ticket.setTicketDirectionTo(ticketId + 1);
//        return ticket;
//    }
//
//}
